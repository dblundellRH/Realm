...
export default {
    ...
    description: `
        Harvest festival is upon us, and one of the key events, as you know, is the pie judging competition. As the honourary judge this year, you must choose which of the three finalists is the winner.

        Coincidentally, each finalist happens to belong to one of the three main factions in the city. Obviously flavour is important, but perhaps it is wiser to consider favour?
    `,
    choices: [
        {
